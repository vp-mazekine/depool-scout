...
/**
 * Java wrapper class for usage of <strong>SetcodeMultisig</strong> contract for Everscale blockchain.
 */
public class SetcodeMultisig extends AbstractContract {
  public SetcodeMultisig(int contextId, String address) throws JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SetcodeMultisig(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public SetcodeMultisig(int contextId, String address, Credentials credentials) throws
      JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),credentials);
  }

  @JsonCreator
  public SetcodeMultisig(int contextId, String address, ContractAbi abi, Credentials credentials) {
