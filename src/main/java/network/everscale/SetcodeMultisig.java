 ...
 */
public record SetcodeMultisig(Sdk sdk, String address, ContractAbi abi,
    Credentials credentials) implements Contract {
  public SetcodeMultisig(Sdk sdk, String address) throws JsonProcessingException {
    this(sdk,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SetcodeMultisig(Sdk sdk, String address, ContractAbi abi) {
    this(sdk,address,abi,Credentials.NONE);
  }

  public SetcodeMultisig(Sdk sdk, String address, Credentials credentials) throws
