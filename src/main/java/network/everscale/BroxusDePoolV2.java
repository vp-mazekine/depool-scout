...
/**
 * Java wrapper class for usage of <strong>BroxusDePoolV2</strong> contract for Everscale blockchain.
 */
public class BroxusDePoolV2 extends DePoolParticipants {
  public BroxusDePoolV2(int contextId, String address) throws JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public BroxusDePoolV2(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public BroxusDePoolV2(int contextId, String address, Credentials credentials) throws
      JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),credentials);
  }

  @JsonCreator
  public BroxusDePoolV2(int contextId, String address, ContractAbi abi, Credentials credentials) {
