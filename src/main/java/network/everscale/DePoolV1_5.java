...
/**
 * Java wrapper class for usage of <strong>DePoolV1_5</strong> contract for Everscale blockchain.
 */
public class DePoolV1_5 extends DePoolParticipants {
  public DePoolV1_5(int contextId, String address) throws JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public DePoolV1_5(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public DePoolV1_5(int contextId, String address, Credentials credentials) throws
      JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),credentials);
  }

  @JsonCreator
  public DePoolV1_5(int contextId, String address, ContractAbi abi, Credentials credentials) {
...
*/
  ...
  public record ResultOfGetDePoolInfo(Boolean poolClosed, BigInteger minStake,
      ...
      Integer validatorRewardFraction, Address validatorWallet, Address[] proxies,
      BigInteger stakeFee, BigInteger retOrReinvFee, BigInteger proxyFee) {
  }
